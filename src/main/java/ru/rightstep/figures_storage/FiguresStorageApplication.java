...
public class FiguresStorageApplication {

    public static void main(String[] args) {
        SpringApplication.run(FiguresStorageApplication.class, args);
    }
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ru.rightstep.figures_storage.model");
